			...
			>
				...
				{showClear && (
					<Button
						...
						className='absolute right-0 top-0 h-full px-3 text-muted-foreground hover:text-foreground !opacity-100 transition-colors duration-200'
				...
				{showPasswordToggle && (
					<Button
						...
						className={cn(
							"absolute top-0 h-full px-3 text-muted-foreground hover:text-foreground hover:opacity-100 transition-colors duration-200",
